...
Encrypt.Instructions2 = function(){};

Encrypt.Instructions2.prototype  = {

    create: function(){
        this.background = this.game.add.tileSprite (0, 0, this.game.width, this.game.height, 'secondInstructionPage');
