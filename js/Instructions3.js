...
Encrypt.Instructions3 = function(){};

Encrypt.Instructions3.prototype  = {

    create: function(){
        this.background = this.game.add.tileSprite (0, 0, this.game.width, this.game.height, 'thirdInstructionPage');
    ...
    nextPage: function(){
        this.game.state.start('Instructions4');
    }
};