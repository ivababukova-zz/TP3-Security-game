...
Encrypt.Instructions5 = function(){};

Encrypt.Instructions5.prototype  = {

    create: function(){
        this.background = this.game.add.tileSprite (0, 0, this.game.width, this.game.height, 'fifthInstructionPage');
