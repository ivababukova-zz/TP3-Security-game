...
Encrypt.Instructions8 = function(){};

Encrypt.Instructions8.prototype  = {

    create: function(){
        this.background = this.game.add.tileSprite (0, 0, this.game.width, this.game.height, 'eighthInstructionPage');
    ...
    previousPage: function(){
        this.game.state.start('Instructions7');
    }
};